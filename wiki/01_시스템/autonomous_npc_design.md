...
> 다른 NPC들이 마을에서 독립적으로 생활하고, 던전에 출입하며, 그 결과를 시스템 메시지로 전달하는 시스템.
> **핵심 원칙**: 기존 시스템(ScheduleRegistry, MetricStore, NPCSpawner, ActionRunner)을 그대로 사용. 새 코드는 최소화.
>
> **단계**: 기획/설계 완료. 구현 시 3~5일 예상.
